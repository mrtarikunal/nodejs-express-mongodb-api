...
//middleware de req,res,next bu üçüne ulaşblyrz.
//middleware kodddaki sıraya göre uygulanr.yani nereye yazrsak ordan itibaren 


app.route('/api/v1/tours/:id').get(getTour).patch(updateTour).delete(deleteTour);
//route ları böyle chain yapablyrz
